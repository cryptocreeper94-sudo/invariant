...
const logo = dom.create("div", { html: "BIOCORE", styles: { fontFamily: "var(--font-heading)", fontWeight: "900", fontSize: "1.5rem", letterSpacing: "0.1em", color: "#E50000" } });
...
const hero_h1 = dom.create("h1", { className: "title-monolith reveal", html: "BIOCORE" });
const hero_h2 = dom.create("h2", { className: "text-stark reveal", html: "Biological Flow Engine", styles: { color: "#E50000", marginTop: "24px" } });
const hero_p = dom.create("p", { className: "text-stark reveal", html: "Metabolic, circulatory, neurological, stress/thermal flows of the human body.", styles: { marginTop: "24px", maxWidth: "600px" } });
...
const eco_h3 = dom.create("h3", { className: "title-monolith", html: "BIOLOGICAL PRIMITIVES", styles: { fontSize: "clamp(2rem, 4vw, 4.5rem)" } });
const eco_track = dom.create("div", { className: "carousel-track reveal" });
const c1 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Metabolic', 'Metabolic Flow'); return false;", href: "#" } });
const c1_in = dom.create("div", { className: "card-inner" });
const c1_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/biocore_metabolic.png" } });
const c1_con = dom.create("div", { className: "card-content" });
const c1_t = dom.create("h4", { className: "card-title", html: "Metabolic Flow" });
const c1_d = dom.create("p", { className: "card-desc", html: "Nutrient sufficiency, glucose stability, oxidative stress routing." });
...
const c2 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Circulatory', 'Circulatory Flow'); return false;", href: "#" } });
const c2_in = dom.create("div", { className: "card-inner" });
const c2_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/biocore_circulatory.png" } });
const c2_con = dom.create("div", { className: "card-content" });
const c2_t = dom.create("h4", { className: "card-title", html: "Circulatory Flow" });
const c2_d = dom.create("p", { className: "card-desc", html: "Heart rate variability, blood pressure stability, fluid retention." });
...
const c3 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Neurological', 'Neurological Flow'); return false;", href: "#" } });
const c3_in = dom.create("div", { className: "card-inner" });
const c3_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/biocore_neurological.png" } });
const c3_con = dom.create("div", { className: "card-content" });
const c3_t = dom.create("h4", { className: "card-title", html: "Neurological Flow" });
const c3_d = dom.create("p", { className: "card-desc", html: "Sleep duration, cognitive clarity, sympathetic vs parasympathetic." });
...
const c4 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Thermal', 'Stress/Thermal Flow'); return false;", href: "#" } });
const c4_in = dom.create("div", { className: "card-inner" });
const c4_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/biocore_stress.png" } });
const c4_con = dom.create("div", { className: "card-content" });
const c4_t = dom.create("h4", { className: "card-title", html: "Stress/Thermal Flow" });
const c4_d = dom.create("p", { className: "card-desc", html: "Acute/chronic stress load, resilience index, endocrine output." });
...
dom.mount(os_core);
dom.mount(overlay);
console.log("BioCore UI Module Loaded.");
