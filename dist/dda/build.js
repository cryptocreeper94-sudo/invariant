/**
 * Lume Browser Bundler for DDA
 * Transforms src/lume/*.lume → dist/dda.js
 * 
...
const distPath = resolve(__dirname, 'dist/dda.js')
...
console.log('  ⟐ Stage 3: VM execution test...')
{
    ...
    try {
        const script = new vm.Script(bundle, { filename: 'dist/dda.js' })
