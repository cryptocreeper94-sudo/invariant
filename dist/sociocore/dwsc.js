...
const logo = dom.create("div", { html: "SOCIOCORE", styles: { fontFamily: "var(--font-heading)", fontWeight: "900", fontSize: "1.5rem", letterSpacing: "0.1em", color: "#333333" } });
...
const hero_h1 = dom.create("h1", { className: "title-monolith reveal", html: "SOCIOCORE" });
const hero_h2 = dom.create("h2", { className: "text-stark reveal", html: "Social Flow Engine", styles: { color: "#333333", marginTop: "24px" } });
const hero_p = dom.create("p", { className: "text-stark reveal", html: "Interpersonal energy, identity coherence, relational stability, communication load.", styles: { marginTop: "24px", maxWidth: "600px" } });
...
const eco_h3 = dom.create("h3", { className: "title-monolith", html: "SOCIAL PRIMITIVES", styles: { fontSize: "clamp(2rem, 4vw, 4.5rem)" } });
const eco_track = dom.create("div", { className: "carousel-track reveal" });
const c1 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Energy', 'Social Energy Flow'); return false;", href: "#" } });
const c1_in = dom.create("div", { className: "card-inner" });
const c1_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/sociocore_energy.png" } });
const c1_con = dom.create("div", { className: "card-content" });
const c1_t = dom.create("h4", { className: "card-title", html: "Social Energy Flow" });
const c1_d = dom.create("p", { className: "card-desc", html: "Social battery drain, boundary integrity, recovery rate." });
...
const c2 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Identity', 'Identity Coherence'); return false;", href: "#" } });
const c2_in = dom.create("div", { className: "card-inner" });
const c2_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/sociocore_identity.png" } });
const c2_con = dom.create("div", { className: "card-content" });
const c2_t = dom.create("h4", { className: "card-title", html: "Identity Coherence" });
const c2_d = dom.create("p", { className: "card-desc", html: "Values alignment, identity drift, masking load." });
...
const c3 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Relational', 'Relational Stability'); return false;", href: "#" } });
const c3_in = dom.create("div", { className: "card-inner" });
const c3_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/sociocore_relational.png" } });
const c3_con = dom.create("div", { className: "card-content" });
const c3_t = dom.create("h4", { className: "card-title", html: "Relational Stability" });
const c3_d = dom.create("p", { className: "card-desc", html: "Conflict load, trust level, attachment security." });
...
const c4 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Communication', 'Communication Load'); return false;", href: "#" } });
const c4_in = dom.create("div", { className: "card-inner" });
const c4_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/sociocore_communication.png" } });
const c4_con = dom.create("div", { className: "card-content" });
const c4_t = dom.create("h4", { className: "card-title", html: "Communication Load" });
const c4_d = dom.create("p", { className: "card-desc", html: "Expressive clarity, digital overload, emotional labor." });
...
dom.mount(os_core);
dom.mount(overlay);
console.log("SocioCore UI Module Loaded.");
