...
const logo = dom.create("div", { html: "NEUROCORE", styles: { fontFamily: "var(--font-heading)", fontWeight: "900", fontSize: "1.5rem", letterSpacing: "0.1em", color: "#0044FF" } });
...
const hero_h1 = dom.create("h1", { className: "title-monolith reveal", html: "NEUROCORE" });
const hero_h2 = dom.create("h2", { className: "text-stark reveal", html: "Cognitive Flow Engine", styles: { color: "#0044FF", marginTop: "24px" } });
const hero_p = dom.create("p", { className: "text-stark reveal", html: "Attention, clarity, emotional load, decision equilibrium, cognitive governance.", styles: { marginTop: "24px", maxWidth: "600px" } });
...
const eco_h3 = dom.create("h3", { className: "title-monolith", html: "COGNITIVE PRIMITIVES", styles: { fontSize: "clamp(2rem, 4vw, 4.5rem)" } });
const eco_track = dom.create("div", { className: "carousel-track reveal" });
const c1 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Attention', 'Attention Flow'); return false;", href: "#" } });
const c1_in = dom.create("div", { className: "card-inner" });
const c1_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/neurocore_attention.png" } });
const c1_con = dom.create("div", { className: "card-content" });
const c1_t = dom.create("h4", { className: "card-title", html: "Attention Flow" });
const c1_d = dom.create("p", { className: "card-desc", html: "Focus duration, task switching cost, attentional bandwidth." });
...
const c2 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Intention', 'Intention Flow'); return false;", href: "#" } });
const c2_in = dom.create("div", { className: "card-inner" });
const c2_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/neurocore_intention.png" } });
const c2_con = dom.create("div", { className: "card-content" });
const c2_t = dom.create("h4", { className: "card-title", html: "Intention Flow" });
const c2_d = dom.create("p", { className: "card-desc", html: "Goal clarity, priority alignment, decision confidence." });
...
const c3 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Emotional', 'Emotional Flow'); return false;", href: "#" } });
const c3_in = dom.create("div", { className: "card-inner" });
const c3_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/neurocore_emotional.png" } });
const c3_con = dom.create("div", { className: "card-content" });
const c3_t = dom.create("h4", { className: "card-title", html: "Emotional Flow" });
const c3_d = dom.create("p", { className: "card-desc", html: "Baseline mood, emotional reactivity, empathy load." });
...
const c4 = dom.create("a", { className: "carousel-card", attrs: { onclick: "openApp('./engine.html?primitive=Cognitive', 'Cognitive Load'); return false;", href: "#" } });
const c4_in = dom.create("div", { className: "card-inner" });
const c4_img = dom.create("img", { className: "card-img", attrs: { src: "./assets/neurocore_cognitive.png" } });
const c4_con = dom.create("div", { className: "card-content" });
const c4_t = dom.create("h4", { className: "card-title", html: "Cognitive Load" });
const c4_d = dom.create("p", { className: "card-desc", html: "Working memory, complexity tolerance, processing speed." });
...
dom.mount(os_core);
dom.mount(overlay);
console.log("NeuroCore UI Module Loaded.");
